...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Help", url="https://t.me/staystrongbros"),
...
async def txt_handler(client: Client, m: Message):
    ...
    f"➤ /start  – 𝐒𝐲𝐬𝐭𝐞𝐦 𝐒𝐭𝐚𝐭𝐮𝐬 ✅\n"
    f"➤ /drm  – 𝐀𝐮𝐭𝐨 .𝐭𝐱𝐭 𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐨𝐫 📄\n"
    f"➤ /y2t  – 𝐘𝐨𝐮𝐓𝐮𝐛𝐞 ➜ .𝐭𝐱𝐭 𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐨𝐫 🎥\n"
    f"➤ /t2t  – 𝐓𝐞𝐱𝐭 ➜ .𝐭𝐱𝐭 𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐫 ✍️\n"
    f"➤ /stop  – 𝐓𝐞𝐫𝐦𝐢𝐧𝐚𝐭𝐞 𝐓𝐚𝐬𝐤 ⛔\n\n"

    f"⚙️ 𝐓𝐎𝐎𝐋𝐒 & 𝐒𝐄𝐓𝐓𝐈𝐍𝐆𝐒:\n"

    f"➤ /cookies  – 𝐔𝐩𝐝𝐚𝐭𝐞 𝐘𝐓 𝐂𝐨𝐨𝐤𝐢𝐞𝐬 🍪\n"
    f"➤ /id  – 𝐆𝐞𝐭 𝐔𝐬𝐞𝐫/𝐂𝐡𝐚𝐭 𝐈𝐃 🆔\n"
    f"➤ /info  – 𝐔𝐬𝐞𝐫 𝐃𝐞𝐭𝐚𝐢𝐥𝐬 🧾\n"
    f"➤ /logs  – 𝐁𝐨𝐭 𝐋𝐨𝐠𝐬 📚\n\n"

    f"👤 𝐔𝐒𝐄𝐑 𝐀𝐔𝐓𝐇𝐄𝐍𝐓𝐈𝐂𝐀𝐓𝐈𝐎𝐍 (𝐎𝐖𝐍𝐄𝐑):\n"

    f"➤ /addauth [𝐔𝐬𝐞𝐫𝐈𝐃]  – 𝐀𝐝𝐝 𝐔𝐬𝐞𝐫 ➕\n"
    f"➤ /remauth [𝐔𝐬𝐞𝐫𝐈𝐃]  – 𝐑𝐞𝐦𝐨𝐯𝐞 𝐔𝐬𝐞𝐫 ➖\n"
    f"➤ /users  – 𝐋𝐢𝐬𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫𝐬 📋\n\n"

    f"📂 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐌𝐀𝐍𝐀𝐆𝐄𝐌𝐄𝐍𝐓:\n"

    f"➤ /addchnl -100xxxx  – 𝐀𝐝𝐝 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🛰️\n"
    f"➤ /remchnl -100xxxx  – 𝐑𝐞𝐦𝐨𝐯𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🚫\n"
    f"➤ /channels  – 𝐂𝐡𝐞𝐜𝐤 𝐀𝐥𝐥 𝐂𝐡𝐚𝐧𝐧𝐞𝐥𝐬 📑\n\n"

    f"💡 𝐍𝐎𝐓𝐄:\n"

    f"• 𝐒𝐞𝐧𝐝 𝐚𝐧𝐲 𝐥𝐢𝐧𝐤 𝐟𝐨𝐫 𝐀𝐮𝐭𝐨-𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐢𝐨𝐧\n"
    f"• 𝐒𝐮𝐩𝐩𝐨𝐫𝐭𝐬 𝐁𝐚𝐭𝐜𝐡 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠\n\n"
